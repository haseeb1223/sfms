...
<div class="row">
  ...
  <div class="row my-3">
    ...
    <input type="number" name="class" min="1" class="form-control" placeholder="class">
  ...
  <div class="row my-3">
    ...
    <input type="number" name="monthly_fee" min="1" class="form-control" placeholder="Rs. monthly fee">

    </div>
    <div class="col">
      
      <input type="number" min="1" name="registration_fee_amount" class="form-control" placeholder="Registration fee">
    </div>
