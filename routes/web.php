...
Route::get('/dashboard/candidate',[AdminController::class, 'candidate'])->middleware('auth')->name('candidate');
Route::get('dashboard/teacher', [AdminController::class, 'teacher'])->name('teacher')->middleware('auth')->middleware('cname');

//registration view.classes candidate
